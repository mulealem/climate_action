<template>
  <div>
    <div class="ql-editor">
      ...
      <p><br /></p>
      <p>
        When you are using the Agir monday app, you are automatically bound by
        the privacy policy of monday.com. You can read it&nbsp;<a
          href="https://monday.com/terms/privacy"
      ...
      <p><br /></p>
      <p>
        When you visit our website or use our web apps, our servers may
        automatically log the standard data provided by your web browser. It may
        include your computer’s Internet Protocol (IP) address, your browser
      ...
      <p>
        ...
        website <span style="font-size: 16px">or our web apps</span>. This data
        may include the device type, operating system, unique device
        identifiers, device settings, and geo-location data. What we collect can
        depend on the individual settings of your device and software. We
      ...
      <p><br /></p>
      <p>We may ask for or collect personal information, such as your:</p>
      <p><br /></p>
      <ul>
        <li>Name</li>
        <li>Email</li>
        <li>Monday account name, logo, and url</li>
      </ul>
      <p><br /></p>
      <h4>Business data</h4>
      <p><br /></p>
      <p>
        ...
        operation on our platform. This may include transaction records, stored
        files, user profiles, analytics data and other metrics, as well as other
        types of information, created or generated, as users interact with our
        apps and services.
      </p>
      <p><br /></p>
      ...
      <p><br /></p>
      <p>
        These legal bases depend on the services and apps you use and how you
      ...
      <p>
        ...
        United States, or where we or our partners, affiliates and third-party
      ...
      <p>
        ...
        guardian’s permission to access and use our website or web apps and they
        (your parents or guardian) have consented to you providing us with your
        personal information. You do not have to provide personal information to
        us, however, if you do not, it may affect your use of this website or
        the products and/or services offered on or through it.
      </p>
      <p><br /></p>
      <p>
        <strong>Information from third parties:&nbsp;</strong>If we receive
        personal information about you from a third party, we will protect it as
        set out in this privacy policy. If you are a third party providing
        personal information about somebody else, you represent and warrant that
        you have such person’s consent to provide the personal information to
        us.
      </p>
      <p><br /></p>
      <p>
        ...
        the details below. If you ask us to restrict or limit how we process
      ...
      <p>
        ...
        request a copy of the personal information we hold about you. Where
        possible, we will provide this information in CSV format or other easily
        readable machine format. You may request that we erase the personal
        information we hold about you at any time. You may also request that we
        transfer this personal information to another third party.
      </p>
      <p><br /></p>
      <p>
      ...
      <p>
        ...
        across our site. A cookie is a small piece of data that our website or
        web apps store on your computer, and accesses each time you visit, so we
        can understand how you use our site. This helps us serve you content
        based on preferences you have specified. Please refer to our&nbsp;<a
          href="https://easyappshq.com/cookie-policy"
          rel="noopener noreferrer"
          target="_blank"
          style="color: rgb(24, 144, 255)"
          >Cookie Policy</a
      ...
      <p><br /></p>
      <p>
        Our website or web apps may link to external sites that are not operated
        by us. Please be aware that we have no control over the content and
        policies of those sites, and cannot accept responsibility or liability
      ...
      <p>
        ...
        about changes via our website or web apps. Your continued use of our
        website or web apps after any changes to this policy will be regarded as
      ...
      <p><br /></p>
      <p><strong>Agir Data Controller</strong></p>
      <p><br /></p>
      <p>Paul Reed</p>
      <p>paulreed@gmail.com</p>
      <p><br /></p>
      <p>This policy is effective as of October 25, 2020.</p>
    </div>
  </div>
</template>
