<template>
  <div>
    <div class="tucupampam" style="z-index: 100">
      ...
      <p>Updated at 2022-09-07</p>
      <br />
      <h1>General Terms</h1>
      <p class="p8">
        <span class="s1"
          >By accessing and placing an order with <a></a>, you confirm that you
          ...
          you and <a></a>. <br /><br />
          Under no circumstances shall <a></a> team be liable for any direct,
          ...
          inability to use, the materials on this site, even if <a></a> team or
          ...
          assume any costs thereof. <br /><br />
          <a></a> will not be responsible for any outcome that may occur during
          the course of usage of our resources. We reserve the rights to change
          prices and revise the resources usage policy in any moment.</span
        >
      </p>
      <p class="p9"><br /></p>
      <h1>License</h1>
      <p class="p10">
        <span class="s1"
          ><a>Agir</a> grants you a revocable, non-exclusive, non- transferable,
          ...
          <a>Agir</a> (referred to in these Terms &amp; Conditions as
          "<a>Agir</a>", "us", "we" or "our"), the provider of the
          <a>Agir</a> website and the services accessible from the
          <a>Agir</a> website (which are collectively referred to in these Terms
          &amp; Conditions as the "<a>Agir</a> Service"). <br /><br />
          ...
          Service. In these Terms &amp; Conditions, "you" refers both to you as
          ...
          account or block access to your account without notice.</span
        >
      </p>
      <p class="p6"><br /></p>
      ...
      <ul class="ul1">
        ...
        <li class="li8">
          <span class="s1"
            ...
            “we,” “us,” or “our,” it refers to <a>Agir</a> that is responsible
            for your information under this Privacy Policy.<br
          /></span>
        </li>
        <li class="li8">
          <span class="s1"
            ><strong>Country:</strong> where <a>Agir</a> or the owners/founders
            of <a>Agir</a> are based, in this case is <a>USA</a>.<br
          /></span>
        </li>
        <li class="li8">
          <span class="s1"
            ><strong>Customer:</strong> refers to the company, organization or
            person that signs up to use the <a>Agir</a> Service to manage the
        ...
        <li class="li8">
          <span class="s1"
            ...
            visit <a>Agir</a> and use the services.<br
          /></span>
        </li>
        <li class="li8">
          <span class="s1"
            ...
            device is connecting to the Internet.<br
          /></span>
        </li>
        <li class="li8">
          <span class="s1"
            ><strong>Personnel:</strong> refers to those individuals who are
            employed by <a>Agir</a> or are under contract to perform a service
            on behalf of one of the parties.<br
          /></span>
        </li>
        <li class="li8">
          <span class="s1"
            ...
            identifiability of a natural person.<br
          /></span>
        </li>
        <li class="li8">
          <span class="s1"
            ><strong>Service:</strong> refers to the service provided by
            <a>Agir</a> as described in the relative terms (if available) and on
            this platform.<br
          /></span>
        </li>
        <li class="li8">
        ...
        <li class="li8">
          <span class="s1"
            ><strong>Website:</strong> <a>Agir</a>’s site, which can be accessed
            via this URL: <a>___________</a><br
          /></span>
        </li>
        <li class="li8">
          <span class="s1"
            ><strong>You:</strong> a person or entity that is registered with
            <a>Agir</a> to use the Services.<br
          /></span>
        </li>
      </ul>
      <p class="p9"><br /></p>
      ...
      <p class="p10">
        <span class="s1"
          >You agree not to, and you will not permit others to:</span
        >
      </p>
      <ul class="ul1">
        <li class="li11">
          <span class="s3"
            ...
            make the platform available to any third party.</span
          >
        </li>
        <li class="li11">
          <span class="s3"
            >Modify, make derivative works of, disassemble, decrypt, reverse
            compile or reverse engineer any part of the service.</span
          >
        </li>
        <li class="li11">
          <span class="s3"
            ...
            suppliers or the licensors of the service.</span
          >
        </li>
      </ul>
      <p class="p3"><br /></p>
      ...
      <p class="p10">
        <span class="s1"
          ...
          order or making a purchase from us, you agree to the terms along with
      ...
      <p class="p10">
        <span class="s1"
          ...
          or any files or other materials which is contained in your account. If
          we decide to change our Terms &amp; Conditions, we will post those
          changes on this page, and/or update the Terms &amp; Conditions
          modification date below.</span
        >
      </p>
      <p class="p3"><br /></p>
      ...
      <p class="p10">
        <span class="s1"
          ...
          or permanently, the service or any service to which it connects, with
          or without notice and without liability to you.</span
        >
      </p>
      <p class="p3"><br /></p>
      ...
      <p class="p10">
        <span class="s1"
          ...
          and/or functionalities of the service to you. You further agree that
          all Updates will be (i) deemed to constitute an integral part of the
          service, and (ii) subject to the terms and conditions of this
          Agreement.</span
        >
      </p>
      <p class="p3"><br /></p>
      ...
      <p class="p10">
        <span class="s1"
          ...
          third parties' terms and conditions.</span
        >
      </p>
      <p class="p3"><br /></p>
      ...
      <p class="p10">
        <span class="s1"
          ...
          service and all copies thereof from your computer. Upon termination of
          this Agreement, you shall cease all use of the service and delete all
          copies of the service from your computer. Termination of this
          Agreement will not limit any of our rights or remedies at law or in
          equity in case of breach by you (during the term of this Agreement) of
          any of your obligations under the present Agreement.</span
        >
      </p>
      <p class="p3"><br /></p>
      <h1>Term and Termination</h1>
      <p class="p10">
        <span class="s1"
          ...
          act on his behalf; (b) identification of the material that is claimed
          to be infringing; (c) your contact information, including your
          address, telephone number, and an email; (d) a statement by you that
          ...
          perjury you are authorized to act on behalf of the owner.</span
        >
      </p>
      <p class="p3"><br /></p>
      ...
      <p class="p10">
        <span class="s1"
          ...
          (c) violation of any right of a third party.</span
        >
      </p>
      <p class="p3"><br /></p>
      <h1>No Warranties</h1>
      <p class="p10">
        <span class="s1"
          ...
          can or will be corrected.<br /><br />
          ...
          and limitations may not apply to you.</span
        >
      </p>
      <p class="p3"><br /></p>
      ...
      <p class="p10">
        <span class="s1"
          ...
          limited to the amount actually paid by you for the service. To the
          maximum extent permitted by applicable law, in no event shall we or
          our suppliers be liable for any special, incidental, indirect, or
          ...
          above limitation or exclusion may not apply to you.</span
        >
      </p>
      <p class="p3"><br /></p>
      <h1>Severability</h1>
      <p class="p10">
        <span class="s1"
          ...
          or any other term, and our failure to assert any right or provision
      ...
      <p class="p10">
        <span class="s1"
          ...
          constitute waiver of any subsequent breach.<br /><br />
          ...
          or other terms, the terms of this Agreement shall govern.</span
        >
      </p>
      <p class="p3"><br /></p>
      ...
      <p class="p10">
        <span class="s1"
          ...
          authorized to use our service.</span
        >
      </p>
      <p class="p3"><br /></p>
      ...
      <p class="p10">
        <span class="s1"
          ...
          or purchase other services from us, which we will provide to you at
          the time of such use or purchase.</span
        >
      </p>
      <p class="p3"><br /></p>
      ...
      <p class="p10">
        <span class="s1"
          ...
          Terms, you can delete your account.</span
        >
      </p>
      <p class="p3"><br /></p>
      ...
      <p class="p10">
        <span class="s1"
          ...
          or in part, without the express prior written permission of us, unless
          and except as is expressly provided in these Terms &amp; Conditions.
          Any unauthorized use of the material is prohibited.</span
        >
      </p>
      <p class="p3"><br /></p>
      ...
      <p class="p10">
        <span class="s1"
          ...
          REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Agir’s INTELLECTUAL
          PROPERTY RIGHTS. The term “dispute” means any dispute, action, or
          other controversy between you and us concerning the Services or this
          ...
          given the broadest possible meaning allowable under law.</span
        >
      </p>
      <p class="p3"><br /></p>
      ...
      <p class="p10">
        <span class="s1"
          ...
          prevailing party shall be borne by the non-prevailing party.</span
        >
      </p>
      <p class="p3"><br /></p>
      ...
      <p class="p10">
        <span class="s1"
          >Don't hesitate to contact us if you have any questions.</span
        >
      </p>
      <ul class="ul1">
        <li class="li16">
          <span class="s3">Via Email: <a>paulreeddev@gmail.com</a></span>
        </li>
        <!---->
        <!---->
        <!---->
